  ...
  analysis: {
    stages: [
      ...
      },
      {
        ...
        label: "Import",
        status: "pending",
        metric: "Planner ready",
        summary: "导入计划将根据当前策略和文件快照实时计算。"
      }
    ],
    images: [
    ...
    collections: [
      {
        ...
        modes: ["Light", "Dark"],
        variables: [
          { name: "color.brand.500", resolvedType: "COLOR", modes: ["Light", "Dark"] },
          { name: "space.4", resolvedType: "FLOAT", modes: ["Light", "Dark"] },
          { name: "radius.md", resolvedType: "FLOAT", modes: ["Light", "Dark"] }
        ]
      },
      {
        name: "Semantics",
        modes: ["Light", "Dark"],
        variables: [
          { name: "text.primary", resolvedType: "COLOR", modes: ["Light", "Dark"], isAlias: true }
        ]
      }
    ]
  }
